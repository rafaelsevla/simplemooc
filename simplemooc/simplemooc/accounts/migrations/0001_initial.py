# Generated by Django 2.1.1 on 2018-10-14 00:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$'), 'Nome de usuário só pode conter letras, digitos e ou os seguintes caracteres @/.+/-/_', 'invalid')], verbose_name='Nome de Usuáro')),
